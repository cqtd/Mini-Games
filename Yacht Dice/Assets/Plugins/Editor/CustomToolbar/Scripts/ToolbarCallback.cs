...
#else
					// Get it's visual tree
					var visualTree = (VisualElement) m_viewVisualTree.GetValue(m_currentToolbar, null);						var visualTree = (VisualElement) m_viewVisualTree.GetValue(m_currentToolbar, null);
#endif
